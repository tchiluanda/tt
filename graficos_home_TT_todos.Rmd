...
ggplot(desp %>% filter(Ano != "2019", !classificador %in% c("Dívida", "Outras Transferências")), aes(x = Ano, y = Valor, color = classificador)) + geom_line(aes(group = classificador))

      
desp %>% spread(key = "Ano", value = "Valor")
