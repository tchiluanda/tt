...
ggplot(dados_slope) +
  geom_segment(
    aes(
      ...
      color = variacao), 
    lineend = "round")+
  geom_text(label="2008", x=0, y=(1.04*(valor_maximo)), hjust = "center", size=4.5, family = "Open Sans") +
  geom_text(label="2017", x=distancia, y=(1.04*valor_maximo), hjust= "center", size=4.5, family = "Open Sans") +
  geom_text(
    aes(x = distancia,
        y = `2017`,
        label = paste(" ",
    ...
    color = 'grey20',
    size = 4) +
  geom_point(aes(x = 0, y = `2008`, color = variacao)) +
  geom_point(aes(x = distancia, y = `2017`, color = variacao)) +
  scale_y_continuous(labels = percent, limits = c(0,1.1*valor_maximo))
  xlim(0, distancia+distancia) +
