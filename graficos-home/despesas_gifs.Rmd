...
pibs <- c(3109803.10,3333039.40,3885847.00,4376382.00,4814760.00,5331619.00,5778953.00,5995787.00,6267205.00,6553842.70)
...
# A ideia do rank (https://www.r-bloggers.com/how-to-build-animated-bar-plots-using-r/)

```{r}
dados_format <- dados_com_cores %>%
  group_by(Ano) %>%
...
graf_linhas + theme(axis.text = element_text(size = 10, family = "Open Sans"))
```
...
```{r}
anim_save("despesas_linhas_loop.gif", animation = last_animation())
```
