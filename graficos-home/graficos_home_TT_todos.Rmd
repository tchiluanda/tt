...
gif_linhas <- grafico_linha +
  ...
  labs(title = "Resultado do Tesouro Nacional", subtitle = paste("Últimos 12 meses, atualizados pelo IPCA, até {lubridate::year(frame_along)}/{meses[lubridate::month(frame_along)]}")) 
...
gif_linhas_dpf <- grafico_linha_dpf +
  transition_reveal(Periodo) +
  labs(title = "Dívida Pública Federal", subtitle = paste("Estoque atualizado pelo IPCA até {lubridate::year(frame_along)}/{meses[lubridate::month(frame_along)]}")) 
