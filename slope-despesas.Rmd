...
## A variação das despesas federais de 2008 para 2017
...
# leitura do PIB do IPEA

pibs <- ipeadata("BM12_PIBAC12")
pibs <- pibs[MES=="12" & ANO %in% (2008:2017)]$VALVALOR
# pibs <- c(pibs,6559940) # acrescentando 2017, que ainda nÃ£o estava lÃ¡
...
# dividindo pelo PIB, tidyverse style
...
# para ajustar as posiÃ§Ãµes dos rÃ³tulos na mÃ£o :/
...
destaques <- c("BenefÃ�cios PrevidenciÃ¡rios RGPS")
